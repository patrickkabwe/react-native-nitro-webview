...
namespace margelo::nitro::nitrowebview {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitrowebview/Func_void;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitrowebview/Func_void_cxx;";
