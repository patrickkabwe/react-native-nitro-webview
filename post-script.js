...
const androidWorkaround = async () => {
 ...
 const viewManagerFile = path.join(
   process.cwd(),
   'nitrogen/generated/android/kotlin/com/margelo/nitro/nitrowebview/views',
   'HybridNitroWebviewManager.kt'
 )

 const viewManagerStr = await readFile(viewManagerFile, { encoding: 'utf8' })
 await writeFile(viewManagerFile, viewManagerStr.replace(/com\.margelo\.nitro\.nitrowebview\.\*/g, 'com.nitrowebview.*'))
